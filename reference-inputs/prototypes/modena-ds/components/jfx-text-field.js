...
<style>
  ...
  input {
    ...
    /* ── Modena text-input: 2-layer background ──
       Layer 0: border gradient (darker top → lighter bottom)
       Layer 1: inner bg with subtle 5px top shadow */
...
class JfxTextField extends HTMLElement {
  static observedAttributes = ['value', 'placeholder', 'disabled', 'readonly', 'maxlength'];
...
customElements.define('jfx-text-field', JfxTextField);
