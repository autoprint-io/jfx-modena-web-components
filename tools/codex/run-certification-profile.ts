...
function run(): void {
  ...
  if (!componentTag) {
    console.error("Usage: node --experimental-strip-types tools/codex/run-certification-profile.ts <jfx-tag> [--print-prompt] [--output file]");
    process.exit(1);
  }
